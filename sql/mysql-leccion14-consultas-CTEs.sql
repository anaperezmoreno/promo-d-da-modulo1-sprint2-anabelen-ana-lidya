...
-- Para empezar nos han mandado hacer una CTE muy sencilla el id del cliente y el nombre 
-- de la compañia de la tabla Customers.
...
-- Mejoremos la query anterior. En este caso queremos saber el número de facturas 
-- emitidas por cada cliente.
